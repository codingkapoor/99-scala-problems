...
class P17Spec extends FlatSpec with Matchers {
  ...
  "splitBuiltin" should "returns a tuple that holds splitted part of a list as it's elements" in {
  ...
  "splitBuiltinII" should "returns a tuple that holds splitted part of a list as it's elements" in {
  ...
  "splitFunctional" should "returns a tuple that holds splitted part of a list as it's elements" in {
  ...
  "splitTailRecursive" should "returns a tuple that holds splitted part of a list as it's elements" in {
