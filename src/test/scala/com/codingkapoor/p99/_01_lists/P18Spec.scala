...
class P18Spec extends FlatSpec with Matchers {
  ...
  "sliceBuiltin" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceBuiltin(3, 17, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceBuiltinII" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceBuiltinII(-1, 7, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceBuiltinIII" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceBuiltinIII(3, -2, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceFunctional" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceFunctional(7, 3, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceFunctionalII" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceFunctionalII(-1, 7, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceFunctionalIII" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceFunctionalIII(-1, 7, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceFunctionalIV" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceFunctionalIV(-1, 7, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceFunctionalV" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceFunctionalV(-1, 7, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceFunctionalVI" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceFunctionalVI(-1, 7, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceTailRecursive" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceTailRecursive(-1, 7, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
  ...
  "sliceTailRecursiveII" should "throw an exception for incorrect parameter values" in {
    intercept[IllegalArgumentException] { P18.sliceTailRecursiveII(-1, 7, List('a, 'b, 'c, 'd, 'e, 'f, 'g, 'h, 'i, 'j, 'k)) }
  }
